...
const SearchStudentItem = memo(({ studentId: id, abbrevName, avatarUrl }: SearchStudentItemProps) => {
    ...
    return <Card
        className={'search-student-item' + (isHovering ? ' search-student-item--hover' : '')}
