import { Avatar, Box, Card, Flex, IconButton, Separator, Text } from '@radix-ui/themes'
...
interface StageBannerProps {
    ...
    answerStudentFullName: string
    answerStudentVariant: string
}
        ...
        >
            ...
            >
                ...
                <IconButton
                    radius='full'
                    color='blue'
                    onClick={() => { selectStore.setIsClear(true) }}
                >
